...
public class Hangman_game_2p extends JFrame {
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         public void run() {
            try {
               Hangman_game_2p frame = new Hangman_game_2p();
...
//      System.out.println(name2);   
      lbl_First.setText(name2);
         ...
         if(name.equals(name2)) {
            ...
            Hangman_main.cntStr2=Hangman_main.cnt3;
            Hangman_result_2p.back1X2=0;
            Hangman_result_2p.back2X2=985;
            Hangman_result_2p.mbackk2=true;
            TimerTask m_task = new TimerTask() {
               ...
               public void run() {
                  ...
                  dispose();
                  setVisible(false);
                  new Hangman_result_2p().setVisible(true);
...
//            
   ...
   //===================================
   public Hangman_game_2p() throws IOException {
      setTitle("SecondPlayer");
...
//         name2+="\t";
       ...
       JButton btn_A = new JButton("");
         ...
         btn_A.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/A.png")));
         ...
         btn_B.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/B.png")));
         ...
         btn_C.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/C.png")));
         ...
         btn_D.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/D.png")));
         ...
         btn_E.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/E.png")));
         ...
         btn_F.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/F.png")));
         ...
         btn_G.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/G.png")));
         ...
         btn_H.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/H.png")));
         ...
         btn_I.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/I.png")));
         ...
         btn_J.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/J.png")));
         ...
         btn_K.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/K.png")));
         ...
         btn_L.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/L.png")));
         ...
         btn_M.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/M.png")));
         ...
         btn_N.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/N.png")));
         ...
         btn_O.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/O.png")));
         ...
         btn_P.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/P.png")));
         ...
         btn_Q.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/Q.png")));
         ...
         btn_R.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/R.png")));
         ...
         btn_S.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/S.png")));
         ...
         btn_T.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/T.png")));
         ...
         btn_U.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/U.png")));
         ...
         btn_V.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/V.png")));
         ...
         btn_W.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/W.png")));
         ...
         btn_X.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/X.png")));
         ...
         btn_Y.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/Y.png")));
         ...
         btn_Z.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/Z.png")));
      ...
      lbl_6 = new JLabel("");
      lbl_6.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uBA38\uB9AC.PNG")));
      lbl_6.setBounds(223, 110, 82, 82);
      contentPane.add(lbl_6);
      
      lbl_4 = new JLabel("");
      lbl_4.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uC624\uB978\uD314.PNG")));
      lbl_4.setBounds(277, 198, 49, 65);
      contentPane.add(lbl_4);
      
      lbl_3 = new JLabel("");
      lbl_3.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uC67C\uD314.PNG")));
      lbl_3.setBounds(205, 198, 55, 59);
      contentPane.add(lbl_3);
      
      lbl_5 = new JLabel("");
      lbl_5.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uBAB8\uD1B5.PNG")));
      lbl_5.setBounds(251, 190, 20, 96);
      contentPane.add(lbl_5);
      
      lbl_2 = new JLabel("");
      lbl_2.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uC67C\uB2E4\uB9AC.PNG")));
      lbl_2.setBounds(205, 285, 62, 59);
      contentPane.add(lbl_2);
      
      lbl_1 = new JLabel("");
      lbl_1.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uC624\uB978\uB2E4\uB9AC.PNG")));
      lbl_1.setBounds(264, 278, 62, 66);
      contentPane.add(lbl_1);
      
      lbl_8 = new JLabel("");
      lbl_8.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uB2E8\uB450\uB3002.PNG")));
      lbl_8.setBounds(57, 89, 394, 305);
      contentPane.add(lbl_8);
      
      lbl_9 = new JLabel("");
      lbl_9.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/\uC8FD\uC5C7\uC744\uB54C.png")));
      ...
      btn_return.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/iconmonstr-door-5-72 (1).png")));
      ...
      btn_coin.setIcon(new ImageIcon(Hangman_game_2p.class.getResource("/image/iconmonstr-coin-2-72 (1).png")));
